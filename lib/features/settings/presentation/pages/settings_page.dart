...
class SettingsPage extends ConsumerWidget {
  ...
  Future<void> _showTestCrashDialog(BuildContext context) async => await showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Test Crash'),
        content: const Text(
  ...
  Future<void> _showResetDialog(BuildContext context, WidgetRef ref) async => await showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Reset Settings'),
        content: const Text(
