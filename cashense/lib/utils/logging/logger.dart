...
class AppLogger {
  ...
  static void state(String controller, String property, dynamic oldValue, dynamic newValue) {
    if (!_shouldLog()) return;
  ...
  static void lifecycle(String event, String screen, {Map<String, dynamic>? data}) {
    if (!_shouldLog()) return;
  ...
  /// Log method entry
  static void methodEntry(String className, String methodName, {Map<String, dynamic>? parameters}) {
    if (!_shouldLog()) return;
  ...
  /// Log method exit
  static void methodExit(String className, String methodName, {dynamic result, Duration? duration}) {
    if (!_shouldLog()) return;
  ...
  static void exception(Object exception, StackTrace stackTrace, {
    ...
    error(buffer.toString(), error: exception, stackTrace: stackTrace, tag: 'Exception');
  }
}